...
def indexPlace():
	try:
		...
		sql = """
			select aes_decrypt(a.id_num,'1zhida**') 'id_num' from _user a,loan b where a.id=b.userSid and a.id_num is not null and b.status=6 and b.createdTime > '2018-01-01';
		"""
		result = db.select(sql)
